                ...
                <div class="panel-body">
                 @if (count($errors) > 0)
                  ...
                  <h2> Insert Photo</h2>
                       ...
                       {!! Form::model($gallery,['method'=>'PATCH','files' => true, 'action'=>['GalleryController@update',  $gallery->id]]) !!}
                     ...
                     <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12 text-center" id="form_sub">
                              <button type="submit" class="btn btn-primary btn-xs">Update gallery</button>
                      </div>
