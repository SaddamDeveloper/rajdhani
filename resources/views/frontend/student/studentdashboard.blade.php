        ...
        <div class="col-md-12">
            ...
            <div class="pay-now-box text-center" style="padding: 180px 0;">
                @if(Auth::guard('student')->user()->class == 'XI' || Auth::guard('student')->user()->class == 'XII')
                    <a href="{{route('frontend.student_admission_11_to_12')}}" class="btn btn-success">FILL UP THE FORM</a>
                @else
                    <a href="{{route('frontend.student_admission_1_to_10')}}" class="btn btn-success">FILL UP THE FORM</a>
                @endif
                </div>
        </div>
    </div>
